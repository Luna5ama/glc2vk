...
import dev.luna5ama.vibris.common.parseReplayCliOptions
...
private val tempLibDir = Path(System.getProperty("java.io.tmpdir"), "dev.luna5ama.vibris")
...
fun main(args: Array<String>) {
    ...
    MemoryStack {
        ...
        val window = run {
            ...
            val width = 800
            val height = 600
            glfwCreateWindow(width, height, "vibris Vulkan".c_str(), nullptr(), nullptr())
        }
        // endregion

        val useValidationLayer = System.getProperty("vibris.validation").toBoolean()
